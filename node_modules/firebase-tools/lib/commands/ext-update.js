...
exports.default = new command_1.Command("ext:update <extensionInstanceId> [updateSource]")
    ...
    try {
        ...
        const isOfficial = newSourceOrigin === extensionsHelper_1.SourceOrigin.OFFICIAL_EXTENSION ||
            newSourceOrigin === extensionsHelper_1.SourceOrigin.OFFICIAL_EXTENSION_VERSION;
        await updateHelper_1.displayChanges(existingSpec, newSpec, isOfficial);
