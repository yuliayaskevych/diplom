...
function addResourcesToBackend(projectId, runtime, annotation, want) {
    ...
    for (const region of annotation.regions || [api.functionsDefaultRegion]) {
        ...
        proto.copyIfPresent(cloudFunction, annotation, "concurrency", "serviceAccountEmail", "labels", "vpcConnectorEgressSettings", "ingressSettings", "timeout", "maxInstances", "minInstances", "availableMemoryMb", "invoker");
